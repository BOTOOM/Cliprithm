...
const translations = {
  en: {
    ...
    mediaLibrary: {
      ...
      unsavedProjectSaveFailed: "The current project could not be saved. Project switching was cancelled.",
      projectChangedDuringLoad: "The project changed while it was loading. The operation was cancelled; please try again.",
    },
    detection: {
      timeline: "Timeline",
    ...
    editor: {
      ...
      speed: "Speed",
      speedTooltip: "Playback speed for this clip. Values above 1× speed up the clip, below 1× slow it down.",
      trim: "Trim source",
      trimTooltip: "Set the in/out points of the source video for this clip.",
      start: "Start",
      startTooltip: "Source time where this clip begins playing.",
      end: "End",
      endTooltip: "Source time where this clip stops playing.",
      split: "Split",
      splitTooltip: "Split the selected clip at the playhead position. Shortcut: S",
      duplicate: "Duplicate",
      duplicateTooltip: "Create a copy of the selected clip right after it.",
      moveLeft: "Move left",
      moveLeftTooltip: "Move the selected clip one position to the left in the timeline.",
      moveRight: "Move right",
      moveRightTooltip: "Move the selected clip one position to the right in the timeline.",
      delete: "Delete clip",
      deleteTooltip: "Remove the selected clip from the timeline. Shortcut: Delete / Backspace",
      videoTrack: "Main video",
      undoTooltip: "Undo the last edit. Shortcut: Ctrl+Z",
      redoTooltip: "Redo the last undone edit. Shortcut: Ctrl+Shift+Z",
      addVideoTooltip: "Import a new video file into the project timeline.",
      analysisScopeTooltip: "Choose whether to analyze only the selected clip or the entire timeline.",
      detectSilenceTooltip: "Run silence detection on the selected scope using the current threshold and duration settings.",
      previewStatus: "Preview engine",
      previewStatusDescription: "Generate a short edited preview around the playhead; source proxies are cached for later reviews.",
      previewReady: "Edited preview ready.",
      ...
      previewUseEdited: "Use edited",
      previewUseSource: "Use source",
      play: "Play",
      pause: "Pause",
      ...
      semanticRanges: "Semantic ranges",
      semanticRangesDescription: "Mark what happens in a clip so AI can use it later.",
      setRangeStart: "Set start",
      setRangeEnd: "Set end",
      rangeStart: "Start",
      rangeEnd: "End",
      rangeTitle: "Range title",
      rangeDescription: "What happens in this range?",
      rangeTags: "Tags, separated by commas",
      createRange: "Create range",
      rangeSetStartFirst: "Set the range start first.",
      rangeRequiredFields: "Set a valid range and complete title and description.",
      rangeCreateFailed: "The semantic range could not be created.",
      addSemanticRange: "Add semantic range",
      updateSemanticRange: "Update semantic range",
      deleteSemanticRange: "Delete semantic range",
      createSemanticRange: "Create semantic range",
      editSemanticRange: "Edit semantic range",
      saveSemanticRange: "Save range",
      cancel: "Cancel",
      closeSemanticRange: "Close semantic range editor",
      semanticRangeModalDescription: "Describe what happens in this timeline segment. Drag either edge to adjust its timing.",
      resizeSemanticRangeStart: "Adjust semantic range start",
      resizeSemanticRangeEnd: "Adjust semantic range end",
      newSemanticRange: "New semantic range",
      cancelRangeTool: "Cancel range tool",
      unplacedRanges: "{{count}} unplaced",
    },
    timeline: {
      timeline: "Timeline",
    ...
    settingsPanel: {
      ...
      mcpDescription: "Let AI clients inspect and edit this video project while Cliprithm is open.",
      mcpEnabled: "Enable MCP server",
      mcpPort: "Local port",
      mcpRunning: "Running at {{url}}",
      mcpStopped: "Stopped",
      mcpStarting: "Starting...",
      mcpError: "MCP error: {{error}}",
      mcpToken: "Bearer token",
      mcpTokenUnavailable: "Start the server to reveal the session token.",
      mcpUrl: "MCP endpoint URL",
      mcpCopyUrl: "Copy MCP endpoint URL",
      mcpCopyToken: "Copy bearer token",
      mcpCopied: "Copied",
      mcpConnection: "Connection details",
      mcpConnectionDescription: "Use these values in your MCP client configuration.",
      mcpTransport: "Transport",
      mcpTransportValue: "Streamable HTTP",
      mcpAuthentication: "Authentication",
      mcpAuthenticationValue: "Bearer token",
      mcpBinding: "Binding",
      mcpBindingValue: "Localhost only",
      mcpSetupExamples: "Client setup examples",
      mcpSetupDescription: "Choose a client to see the exact JSON shape and where to place it.",
      mcpConfigSecurity: "These examples include the current token when the server is running. Do not commit the copied JSON to source control.",
      mcpCopyConfig: "Copy configuration JSON",
      mcpClaude: "Claude Desktop",
      mcpClaudeDescription: "Claude Desktop uses the mcp-remote bridge to connect to this local HTTP server.",
      mcpClaudeLocation: "File: claude_desktop_config.json",
      mcpVsCode: "VS Code",
      mcpVsCodeDescription: "Add this server to VS Code MCP configuration using the HTTP transport.",
      mcpVsCodeLocation: "File: .vscode/mcp.json or your user MCP configuration",
      mcpDevin: "Devin",
      mcpDevinDescription: "Add this remote HTTP server to Devin's local MCP configuration.",
      mcpDevinLocation: "File: .devin/mcp_config.local.json (recommended)",
      mcpSecurity: "Only clients with this session token can connect. Keep it private.",
    },
    diagnostics: {
      title: "Diagnostics",
      description:
  ...
  es: {
    ...
    mediaLibrary: {
      ...
      unsavedProjectSaveFailed: "No se pudo guardar el proyecto actual. Se cancelo el cambio de proyecto.",
      projectChangedDuringLoad: "El proyecto cambio mientras se cargaba. La operacion se cancelo; vuelve a intentarlo.",
    },
    detection: {
      timeline: "Timeline",
    ...
    editor: {
      ...
      speed: "Velocidad",
      speedTooltip: "Velocidad de reproduccion de este clip. Valores above 1× aceleran el clip, debajo de 1× lo ralentizan.",
      trim: "Recortar fuente",
      trimTooltip: "Define los puntos de entrada/salida del video fuente para este clip.",
      start: "Inicio",
      startTooltip: "Tiempo fuente donde este clip comienza a reproducirse.",
      end: "Final",
      endTooltip: "Tiempo fuente donde este clip deja de reproducirse.",
      split: "Dividir",
      splitTooltip: "Divide el clip seleccionado en la posicion del playhead. Atajo: S",
      duplicate: "Duplicar",
      duplicateTooltip: "Crea una copia del clip seleccionado justo despues de este.",
      moveLeft: "Mover a la izquierda",
      moveLeftTooltip: "Mueve el clip seleccionado una posicion a la izquierda en la timeline.",
      moveRight: "Mover a la derecha",
      moveRightTooltip: "Mueve el clip seleccionado una posicion a la derecha en la timeline.",
      delete: "Eliminar clip",
      deleteTooltip: "Elimina el clip seleccionado de la timeline. Atajo: Delete / Backspace",
      videoTrack: "Video principal",
      undoTooltip: "Deshacer la ultima edicion. Atajo: Ctrl+Z",
      redoTooltip: "Rehacer la ultima edicion deshecha. Atajo: Ctrl+Shift+Z",
      addVideoTooltip: "Importar un nuevo archivo de video a la timeline del proyecto.",
      analysisScopeTooltip: "Elige si analizar solo el clip seleccionado o toda la timeline.",
      detectSilenceTooltip: "Ejecutar la deteccion de silencios en el alcance seleccionado con los valores actuales de umbral y duracion.",
      previewStatus: "Motor de preview",
      previewStatusDescription: "Genera un preview editado corto alrededor del playhead; los proxies fuente se guardan para revisiones posteriores.",
      previewReady: "Preview editado listo.",
      previewUnavailable: "No se pudo iniciar el preview.",
      previewNotGenerated: "No generado",
      previewGenerate: "Generar preview",
      previewGenerating: "Generando preview…",
      previewCancel: "Cancelar",
      previewUseEdited: "Usar editado",
      previewUseSource: "Usar fuente",
      play: "Reproducir",
      pause: "Pausar",
      ...
      semanticRanges: "Rangos semanticos",
      semanticRangesDescription: "Marca lo que ocurre en un clip para que la IA lo use despues.",
      setRangeStart: "Fijar inicio",
      setRangeEnd: "Fijar final",
      rangeStart: "Inicio",
      rangeEnd: "Final",
      rangeTitle: "Titulo del rango",
      rangeDescription: "¿Que ocurre en este rango?",
      rangeTags: "Tags separados por comas",
      createRange: "Crear rango",
      rangeSetStartFirst: "Fija primero el inicio del rango.",
      rangeRequiredFields: "Fija un rango valido y completa titulo y descripcion.",
      rangeCreateFailed: "No se pudo crear el rango semantico.",
      addSemanticRange: "Agregar rango semantico",
      updateSemanticRange: "Actualizar rango semantico",
      deleteSemanticRange: "Eliminar rango semantico",
      createSemanticRange: "Crear rango semantico",
      editSemanticRange: "Editar rango semantico",
      saveSemanticRange: "Guardar rango",
      cancel: "Cancelar",
      closeSemanticRange: "Cerrar editor de rango semantico",
      semanticRangeModalDescription: "Describe lo que ocurre en este segmento de la timeline. Arrastra cualquiera de sus extremos para ajustar el tiempo.",
      resizeSemanticRangeStart: "Ajustar inicio del rango semantico",
      resizeSemanticRangeEnd: "Ajustar final del rango semantico",
      newSemanticRange: "Nuevo rango semantico",
      cancelRangeTool: "Cancelar herramienta de rango",
      unplacedRanges: "{{count}} sin colocar",
    },
    timeline: {
      timeline: "Timeline",
    ...
    settingsPanel: {
      ...
      mcpDescription: "Permite que clientes de IA consulten y editen este proyecto mientras Cliprithm esta abierto.",
      mcpEnabled: "Activar servidor MCP",
      mcpPort: "Puerto local",
      mcpRunning: "Activo en {{url}}",
      mcpStopped: "Detenido",
      mcpStarting: "Iniciando...",
      mcpError: "Error MCP: {{error}}",
      mcpToken: "Token Bearer",
      mcpTokenUnavailable: "Inicia el servidor para revelar el token de sesion.",
      mcpUrl: "URL del endpoint MCP",
      mcpCopyUrl: "Copiar URL del endpoint MCP",
      mcpCopyToken: "Copiar token Bearer",
      mcpCopied: "Copiado",
      mcpConnection: "Detalles de conexion",
      mcpConnectionDescription: "Usa estos valores en la configuracion de tu cliente MCP.",
      mcpTransport: "Transporte",
      mcpTransportValue: "HTTP con streaming",
      mcpAuthentication: "Autenticacion",
      mcpAuthenticationValue: "Token Bearer",
      mcpBinding: "Binding",
      mcpBindingValue: "Solo localhost",
      mcpSetupExamples: "Ejemplos de configuracion",
      mcpSetupDescription: "Elige un cliente para ver el formato JSON exacto y donde colocarlo.",
      mcpConfigSecurity: "Estos ejemplos incluyen el token actual cuando el servidor esta activo. No guardes el JSON copiado en el control de versiones.",
      mcpCopyConfig: "Copiar JSON de configuracion",
      mcpClaude: "Claude Desktop",
      mcpClaudeDescription: "Claude Desktop usa el puente mcp-remote para conectarse a este servidor HTTP local.",
      mcpClaudeLocation: "Archivo: claude_desktop_config.json",
      mcpVsCode: "VS Code",
      mcpVsCodeDescription: "Agrega este servidor a la configuracion MCP de VS Code usando transporte HTTP.",
      mcpVsCodeLocation: "Archivo: .vscode/mcp.json o la configuracion MCP de usuario",
      mcpDevin: "Devin",
      mcpDevinDescription: "Agrega este servidor HTTP remoto a la configuracion MCP local de Devin.",
      mcpDevinLocation: "Archivo: .devin/mcp_config.local.json (recomendado)",
      mcpSecurity: "Solo los clientes con este token de sesion pueden conectarse. Mantenlo privado.",
    },
    diagnostics: {
      title: "Diagnosticos",
      description:
